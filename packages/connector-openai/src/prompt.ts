...
export type OpenAiPromptBuilder = (input: DionysysDecisionInput) => string;

export const defaultOpenAiInstructions =
  'You are the Dionysys adaptive UI decision engine. Return only the JSON object requested by the schema.';

export const defaultOpenAiPromptBuilder: OpenAiPromptBuilder = (input) => {
