...
export function getConnectorStatus(): AdminConnectorStatus {
  return {
    type: process.env.ADAPTIVE_LLM_ENDPOINT ? 'custom-http' : 'mock',
...
export function getAdminApiEndpoints(): AdminApiEndpoint[] {
  ...
  return [
    { method: 'GET', path: '/api/dionysys/admin/config', description: 'Primary SDK route for reading active runtime admin configuration.', enabled },
    { method: 'PUT', path: '/api/dionysys/admin/config', description: 'Primary SDK route for replacing active runtime admin configuration.', enabled },
    { method: 'POST', path: '/api/dionysys/admin/config/reset', description: 'Primary SDK route for resetting runtime configuration to defaults.', enabled },
    { method: 'GET', path: '/api/dionysys/admin/config/export', description: 'Primary SDK route for exporting runtime configuration as JSON.', enabled },
    { method: 'GET', path: '/api/dionysys/admin/overview', description: 'Primary SDK route for connector, API, and optional session calculations.', enabled },
    { method: 'POST', path: '/api/dionysys/decisions:resolve', description: 'Primary SDK route for deterministic and MCP decision resolution.', enabled: true },
  ];
}
